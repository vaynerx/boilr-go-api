module {{ if Owner }}{{Owner}}{{ end }}.{{AppName}}
...
replace (
  {{ if Owner }}{{Owner}}{{ end }}.{{AppName}}/cmd/app => ./cmd/app
  {{ if Owner }}{{Owner}}{{ end }}.{{AppName}}/internal/app => ./internal/app
  {{ if Owner }}{{Owner}}{{ end }}.{{AppName}}/api/proto/{{AppName}}/api => ./api/proto/{{AppName}}/api
